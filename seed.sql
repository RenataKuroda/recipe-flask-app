INSERT INTO recipes (title, description, ingredients, instructions, image_url, created_at, user_id)
VALUES ('Classic Margherita Pizza', 'A classic pizza made with tomato sauce, mozzarella cheese, and fresh basil', 
        ...
        'https://images.unsplash.com/photo-1600028068383-ea11a7a101f3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80', DATE_TRUNC('day', NOW()), 1
        );
...
VALUES ('Spinach and Feta Stuffed Chicken', 
        ...
        'https://media.istockphoto.com/id/118313946/photo/chicken-breasts-stuffed-with-spinach-and-feta.jpg?s=612x612&w=is&k=20&c=RoMZTAJvrgDQCGERiVEKmSjxoObr7CZYYoe9ZQaZz5I=', DATE_TRUNC('day', NOW()), 1
        );
